      ...
      *-----------------------------------------------------------------
       ALTERAR                                                SECTION.
      *----------------------------------
           MOVE 'Deseja alterar o status atual? (S/N)' TO SCR-TRL-L2
           DISPLAY SCR-TRL

           ACCEPT WRK-OPCAO                        LINE 24 COLUMN 38
           ...
           COMPUTE ARQCRM-STATUS = 1 - ARQCRM-STATUS
           ...
           EVALUATE ARQCRM-FS
              WHEN 0
                 ...
                 DISPLAY SCR-TRL
                 ACCEPT WRK-OPCAO                  LINE 24 COLUMN 19
              WHEN OTHER
